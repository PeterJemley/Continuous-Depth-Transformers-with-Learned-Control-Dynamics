...
![Control Interpolation](control_interpolation.png)

*Figure 2: Sweeping the control signal from -2 to +2. The smooth sigmoid curves demonstrate continuous semantic steering—intermediate values produce mixed sentiment states, not discrete jumps.*
